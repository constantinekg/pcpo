...
def ssh_wmi_getter(ipaddr,user,pwd,max_bytes=60000):
    try:
        ...
        video_info_command = 'powershell -command "Get-WmiObject -ClassName Win32_VideoController | Select-Object -Property Name,PNPDeviceID,SerialNumber | ConvertTo-Json"'
        drives_info_command = 'powershell -command "Get-WmiObject -ClassName win32_DiskDrive | Select-Object -Property Model,Size,SerialNumber | ConvertTo-Json"'
        client = SSHClient()
